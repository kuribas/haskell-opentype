...
data HeadTable = HeadTable {
  -- | 0x00010000 for version 1.0.  /Will be overwritten with the correct value./
  headVersion :: Fixed,
  ...
  -- | 0 for short offsets, 1 for long.  /Will be overwritten with the correct value./
  longLocIndices :: Bool,
  -- | 0 for current format.  /Will be overwritten with the correct value./
